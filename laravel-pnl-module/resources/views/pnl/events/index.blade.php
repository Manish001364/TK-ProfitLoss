                ...
                <tbody>
                    @forelse($events as $event)
                        <tr>
                            ...
                            <td class="text-right">₹{{ number_format($event->budget, 0) }}</td>
                            <td class="text-right text-success">₹{{ number_format($event->total_revenue, 0) }}</td>
                            <td class="text-right text-danger">₹{{ number_format($event->total_expenses, 0) }}</td>
                            <td class="text-right">
