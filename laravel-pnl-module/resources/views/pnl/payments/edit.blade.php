                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="reminder_enabled" name="reminder_enabled" value="1" 
                                               {{ old('reminder_enabled', $payment->reminder_enabled) ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="reminder_enabled">Enable Reminders</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="custom-control custom-switch mt-4">
                                        <input type="checkbox" class="custom-control-input" id="reminder_on_due_date" name="reminder_on_due_date" value="1" 
                                               {{ old('reminder_on_due_date', $payment->reminder_on_due_date) ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="reminder_on_due_date">Remind on Due Date</label>
                                    </div>
                                </div>
                            </div>
                        </div>
