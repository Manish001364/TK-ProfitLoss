...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0"><i class="fas fa-credit-card"></i> Payment Tracking</h1>
            <div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-2 mb-md-0">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="overdue" name="overdue" value="1" {{ request('overdue') ? 'checked' : '' }}>
                                <label class="form-check-label" for="overdue">Show Only Overdue</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <tbody>
                            @forelse($payments as $payment)
                                <tr class="{{ $payment->is_overdue ? 'table-danger' : '' }}">
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $payment->status_color }}">{{ ucfirst($payment->status) }}</span>
