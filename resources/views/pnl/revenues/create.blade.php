...
@section('content_header')
    <h1><i class="fas fa-plus-circle"></i> Add Revenue Entry</h1>
@stop
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-calculator"></i> Revenue Summary</h3>
                    </div>
                    <div class="card-body">
                        <table class="table table-sm">
                            <tr>
                                <td>Gross Revenue:</td>
                                <td class="text-right" id="gross_display">₹0</td>
                            </tr>
                            <tr class="text-danger">
                                <td>- Platform Fees:</td>
                                <td class="text-right" id="platform_display">₹0</td>
                            </tr>
                            <tr class="text-danger">
                                <td>- Gateway Fees:</td>
                                <td class="text-right" id="gateway_display">₹0</td>
                            </tr>
                            <tr class="text-danger">
                                <td>- Taxes:</td>
                                <td class="text-right" id="taxes_display">₹0</td>
                            </tr>
                            <tr>
                                <td><strong>Net Revenue:</strong></td>
                                <td class="text-right text-success" id="net_display"><strong>₹0</strong></td>
                            </tr>
                            <tr class="text-warning">
                                <td>- Refunds:</td>
                                <td class="text-right" id="refund_display">₹0</td>
                            </tr>
                            <tr class="table-success">
                                <td><strong>Final Revenue:</strong></td>
                                <td class="text-right" id="final_display"><strong>₹0</strong></td>
                            </tr>
                        </table>
                    </div>
                </div>
